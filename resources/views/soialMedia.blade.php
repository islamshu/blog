        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                <div class="feat-item wow animate__fadeInUp">
                    <div class="img-box">
                        <img src="{{asset('front/images/innerFeatures/soialMedia/graphic-design.png')}}" alt="">
                    </div>
                    <h3>تصـــاميم مبتكـــرة</h3>
                    <p>نعمل جاهدين على إيصال فكرتك او منتجك بأفضل شكل ممكن يتناسب مع السوق بشكل مميز.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="feat-item wow animate__fadeInUp">
                    <div class="img-box">
                        <img src="{{asset('front/images/innerFeatures/soialMedia/social-media.png')}}" alt="">
                    </div>
                    <h3>ادارة صفحــات احترافيـــة</h3>
                    <p>نعمل على إدارة أعمالك على منصات التواصل الإجتماعي بمهنية عالية تضمن لك الراحة في ادارة اعمالك.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="feat-item wow animate__fadeInUp">
                    <div class="img-box">
                        <img src="{{asset('front/images/innerFeatures/soialMedia/blogger.png')}}" alt="">
                    </div>
                    <h3>محتــــوى ممــــيز</h3>
                    <p>نمتلك كتاب محتوى مميزين قادرين على إخراج أفكار بالمحتوى الأمثل لمشروعك.</p>
                </div>
            </div>
