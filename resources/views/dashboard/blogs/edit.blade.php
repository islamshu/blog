                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="title" required class="form-control ckeditor" id="" cols="30" rows="10">{{ $blog->title }}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" required class="form-control ckeditor" id="" cols="30" rows="10">{{ $blog->description }}</textarea>
                                                </div>
                                            </div>
