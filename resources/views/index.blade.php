  ...
  <main>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="feat-item">
              ...
              <p>
                خدمة إدارة الإعلانات على المنصات المختلفة من ميتا , جوجل و سناب شات وتيكتوك.
              </p>
              <a href="">المزيد</a>
            </div>
          </div>
    ...
    <div class="whyUs" id="ourServices">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="number-item">
              <p class="d-inline-block">+</p> <span data-top="500" class="num">0</span>
      ...
      <div class="contact">
        <div class="row align-items-center">
          <div class="col-lg-8 text-end pe-4">
            ...
            <p class="wow animate__fadeInRight">مهما كانت احتياجاتك مهما كانت احتياجاتك مهما كانت احتياجاتك</p>
          </div>

          <div class="col-lg-4">
            <a href="" class="wow animate__fadeInLeft">اطلب الخدمة</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="ourValue " id="ourClients">
        <h2 class="wow animate__fadeInUp">عملائنا يكررون طلب منتجاتنا</h2>
        <p class="wow animate__fadeInUp">اكثر من مرة وهذا دليل رضاهم</p>
        <div class="row">
          <div class="col-lg-6">
            <div class="fields">
              <div class="field">
              ...
              <div class="field">
                ...
                <span class="amount"><span class="presntege" data-range="30"></span></span>
              </div>
            </div>
          </div>
    ...
    <div class="ourWork" id="ourWork">
      <div class="container">
        ...
        <p class="wow animate__fadeInUp">
          تلتزم وكالة بومباستك ميديا بتزويدك بافضل الخدمات التي يحتاجها عملك
          والتي ستنقل عمالك الى المستوى التالي
        </p>
    ...
    <div class="ourClients" id="ourClents">
      <div class="container">
        ...
        <p class="wow animate__fadeInUp">
          تلتزم وكالة بومباستك ميديا بتزويدك بافضل الخدمات التي يحتاجها عملك
          والتي ستنقل عمالك الى المستوى التالي التي يحتاجها عملك
          والتي ستنقل عمالك الى المستوى التالي التي يحتاجها عملك
          والتي ستنقل عمالك 
        </p>
        <div class="row">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="blog-item wow animate__fadeInUp">
              <a href="">
                <div class="img">
                  <img src="{{asset('front/images/blog.png')}}" alt="" />
                </div>
                <div class="item-body">
